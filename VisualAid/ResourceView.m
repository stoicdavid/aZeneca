...
@synthesize fileName, localResponder;

- (id) initWithFrame:(CGRect)frame withLocalResponder:(ListViewController *)controller withTitle:(NSString*)title andFileName:(NSString*)fileName_
{
